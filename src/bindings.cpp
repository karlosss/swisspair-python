...
PYBIND11_MODULE(_swisspair, m) {
  ...
  py::class_<Player>(m, "Player")
      ...
      .def_readwrite("cannot_be_paired_against_ids",
                     &Player::cannot_be_paired_against_ids)
  ...
  m.def("create_matches", &create_matches,
        "Creates a list of matches, ordered by the table number from the "
        "highest table. Power pairing guarantees the top 8 players to be "
        "paired according to their standing.");
}
